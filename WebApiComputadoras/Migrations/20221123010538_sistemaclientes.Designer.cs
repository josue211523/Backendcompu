...
namespace WebApiComputadoras.Migrations
{
    ...
    [Migration("20221123010538_sistemaclientes")]
    partial class sistemaclientes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApiComputadoras.Entitys.ComputadorasComplementos", b =>
                {
                    b.Property<int>("ComputadorasId")
                        .HasColumnType("int");

                    b.Property<int>("ComplentosId")
                        .HasColumnType("int");

                    b.Property<int?>("ComplementosId")
                        .HasColumnType("int");

                    b.HasKey("ComputadorasId", "ComplentosId");

                    b.HasIndex("ComplementosId");

                    b.ToTable("ComputadorasComplementos");
                });
            ...
            modelBuilder.Entity("WebApiComputadoras.Entitys.ComputadorasComplementos", b =>
                {
                    b.HasOne("WebApiComputadoras.Entitys.Complementos", "Complementos")
                        .WithMany()
                        .HasForeignKey("ComplementosId");

                    b.HasOne("WebApiComputadoras.Entitys.Computadoras", "Computadoras")
                        .WithMany()
